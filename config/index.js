export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxefc1adf38b1a0dba",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "55f7df88d0d22d27e9cab8c6d2d94336",
  ...
  USERS: [
    {
      ...
      id: "o4ywU56Is43n08uwG0g2_4yaMgkU",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "5yvK7zfuog5Jr_W1ScyFZ-PsdDpx36UdRq0hJWqyvxk	",
      // 所在省份
      province: "郑州",
      // 所在城市
      city: "二七区",
